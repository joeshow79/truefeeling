...
import com.tf.truefeeling.bluetooth.BLEAction;
import com.tf.truefeeling.bluetooth.BLETask;
import com.tf.truefeeling.bluetooth.BTCommandManager;
...
import com.tf.truefeeling.model.BatteryInfo;
import com.tf.truefeeling.model.LedColor;
import com.tf.truefeeling.model.MiBandData;
import com.tf.truefeeling.model.Profile;
import com.tf.truefeeling.model.Protocol;
import com.tf.truefeeling.model.UserInfo;
import com.tf.truefeeling.model.VibrationMode;
import com.tf.truefeeling.model.MiBandData;
...
public class MiBand {
    ...
    private static final String TAG = "MiBandData";
    ...
    public void connect(String addr, final ActionCallback callback) {
        if (!isConnected()) {
            connectionCallback = callback;
            btConnectionManager.connect(addr);
        } else {
            Log.e(TAG, "Already connected...");
        }
    }
    ...
    public void stopVibration() {
        ...
        //MiBandData.io.writeCharacteristic(Profile.UUID_CHAR_CONTROL_POINT, Protocol.STOP_VIBRATION, null);
    ...
    public void setDisconnectedListener(NotifyListener listener) {
        MiBand.io.setDisconnectedListener(listener);
    }
    ...
    public void enableRealtimeStepsNotify() {
        ...
        //MiBandData.io.writeCharacteristic(Profile.UUID_CHAR_CONTROL_POINT, Protocol.ENABLE_REALTIME_STEPS_NOTIFY, null);
    ...
    public void disableRealtimeStepsNotify() {
        ...
        //MiBandData.io.writeCharacteristic(Profile.UUID_CHAR_CONTROL_POINT, Protocol.DISABLE_REALTIME_STEPS_NOTIFY, null);
    ...
    public void setUserInfo(int gender, int age, int height, int weight, String alias) {
        ...
        //MiBandData.io.writeCharacteristic(Profile.UUID_CHAR_USER_INFO, user.getData(), null);
    ...
    public void selfTest() {
        ...
        //MiBandData.io.writeCharacteristic(Profile.UUID_CHAR_TEST, Protocol.SELF_TEST, null);
    ...
    public void getStepData() {
        ...
        ActionCallback ioCallback = new ActionCallback() {
            ...
            public void onSuccess(Object data) {
                BluetoothGattCharacteristic characteristic = (BluetoothGattCharacteristic) data;
                Log.d(TAG, "getStepData: " + String.valueOf(characteristic.getValue()));
            }
