...
import com.tf.truefeeling.Model.Battery;
import com.tf.truefeeling.Model.LeParams;
import com.tf.truefeeling.Model.MiBand;
import com.tf.truefeeling.View.ColorPickerDialog;
...
public class MiOverviewActivity extends Activity implements Observer {
    ...
    private String TAG = "MiOverviewActivity";
    ...
    private void pair() {
        ...
        com.tf.truefeeling.Util.Log.d(TAG, "pair sent");
    }
