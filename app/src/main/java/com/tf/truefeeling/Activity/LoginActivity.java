...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mEmailSignInButton = (Button) findViewById(R.id.account_sign_in_button);
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        ...
        addEmailsToAutoComplete(accounts);
    }
    ...
    private void addEmailsToAutoComplete(List<String> accountAddressCollection) {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            AVUser.logOut();
            //AVUser.logInInBackground(mEmail, mPassword, new LogInCallback<AVUser>() {
             AVUser.logInInBackground(mEmail, mPassword, new LogInCallback<AVUser>() {
                @Override
                public void done(AVUser avUser, AVException e) {
                    if (e != null) {
                        ...
                        //startActivity(new Intent(LoginActivity.this, MiActivity_tbd.class));
                    }
                }
            });
